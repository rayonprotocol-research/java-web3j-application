 ...
 *
 * <ol>
 * <li>Ethereum client (or node) endpoint. The simplest thing to do is <a href="https://infura.io/register.html">request a free access token from Infura</a></li>
 * <li>A wallet file. This can be generated using the web3j <a href="https://docs.web3j.io/command_line.html">command line tools</a></li>
 * <li>Some Ether. This can be requested from the <a href="https://www.rinkeby.io/#faucet">Rinkeby Faucet</a></li>
 * </ol>
 *
 * <p>
...
public class Application {
	...
	private void run() throws Exception {
		...
		Web3j web3j = Web3j.build(new HttpService("http://192.168.3.102:8551"));
		// Web3j web3j = Web3j.build(new HttpService());
		// Web3j web3j = Web3j.build(new HttpService("https://rinkeby.infura.io/<your token>")); // FIXME: Enter your Infura token here;
		log.info("Connected to Ethereum client version: " + web3j.web3ClientVersion().send().getWeb3ClientVersion());

		// We then need to load our Ethereum wallet file
		// FIXME: Generate a new wallet file using the web3j command line tools https://docs.web3j.io/command_line.html
		Credentials credentials = WalletUtils.loadCredentials("scion1234", "/Users/scion/klaytn-accounts/keystore-scion1");
		log.info("Credentials loaded");

		// // FIXME: Request some Ether for the Rinkeby test network at https://www.rinkeby.io/#faucet
		// log.info("Sending 1 Wei (" + Convert.fromWei("1", Convert.Unit.ETHER).toPlainString() + " Ether)");
		// TransactionReceipt transferReceipt = Transfer.sendFunds(web3j, credentials, "0x47590e57F74d3de66bD36230dE2dEc5c4e9E12f2", // you can put any address here
		...
		ContractGasProvider contractGasProvider = new StaticGasProvider(new BigInteger("25000000000"), new BigInteger("20000000"));
